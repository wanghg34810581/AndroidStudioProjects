...
package com.ktouch.datetimepicker.date;
...
import com.ktouch.datetimepicker.R;
import com.ktouch.datetimepicker.Utils;
import com.ktouch.datetimepicker.date.MonthAdapter.CalendarDay;
...
public abstract class MonthView extends View {
    ...
    protected static int DEFAULT_HEIGHT = 9;
    protected static int MIN_HEIGHT = 9;
    ...
    public static final boolean SHOW_WEEK_DAY = false;
    ...
    protected void drawMonthTitle(Canvas canvas) {
        ...
        int y ;
        if(SHOW_WEEK_DAY){
            y = (getMonthHeaderSize() - mMonthDayLabelTextSize) / 2 + (mMonthLabelTextSize / 3);
        } else {
            y = getMonthHeaderSize() / 2 + (mMonthLabelTextSize / 3);
        }
    ...
    protected void drawMonthNums(Canvas canvas) {
        ...
        int y;
        if(SHOW_WEEK_DAY){
            y = (((mRowHeight + mMiniDayNumberTextSize) / 2) - mDaySeparatorWidth)
                    + getMonthHeaderSize();
        } else {
            y = getMonthHeaderSize() - (mMonthDayLabelTextSize / 2);
        }
