...
package com.qti.lunarinfo;

import android.content.Context;
import android.text.TextUtils;

import com.ktouch.kcalendar.LunarUtils;
import com.qti.lunarinfo.LunarInfo.DateInfo;
...
public class FestivalParser {
    ...
    public static void getFestivals(Context context, DateInfo date, ArrayList<String> list) {
        ...
        // Added IF-LIMIT for settings. begin
        if (LunarUtils.showChineseFestivals(context))
            getLunarFestival(context, date, list);
        if (LunarUtils.showWesternFestivals(context))
            getSolarFestival(context, date, list);
        // Added IF-LIMIT for settings. end
    }
