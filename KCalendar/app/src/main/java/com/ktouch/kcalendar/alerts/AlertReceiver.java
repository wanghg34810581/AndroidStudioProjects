...
package com.ktouch.kcalendar.alerts;
...
import com.ktouch.kcalendar.alerts.AlertService.NotificationWrapper;
 ...
 *    -n "com.ktouch.kcalendar/.alerts.AlertReceiver"
 */
public class AlertReceiver extends BroadcastReceiver {
    private static final String TAG = "AlertReceiver";

    private static final String MAP_ACTION = "com.ktouch.kcalendar.MAP";
    private static final String CALL_ACTION = "com.ktouch.kcalendar.CALL";
    private static final String MAIL_ACTION = "com.ktouch.kcalendar.MAIL";
    ...
    public static final String EVENT_REMINDER_APP_ACTION =
            "com.ktouch.kcalendar.EVENT_REMINDER_APP";
    ...
    private static Notification buildBasicNotification(Notification.Builder notificationBuilder,
        ...
        if (Utils.isJellybeanOrLater()) {
            ...
            //yanghong modify on May8.2015
            //if donot popup, the priority need to adjust to default
            if(!doPopup){
...
//            notificationBuilder.setCategory(Notification.CATEGORY_ALARM);
            ...
            if (snoozeIntent != null && numActions < MAX_NOTIF_ACTIONS) {
                ...
                //yanghong merge from Android4.4
