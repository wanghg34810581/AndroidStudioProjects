    ...
    public void delete(long begin, long end, CalendarEventModel model, int which) {
        ...
        if (TextUtils.isEmpty(rRule)) {
            ...
            if (mSyncId == null) {
                ...
                labelArray.remove(0);
                labelIndex.remove(0);
                //yanghong add the condition:mStartMillis == model.mStart to repeat the function of clearing the all events. on Jan.22,2015
                if (!model.mIsOrganizer || mStartMillis == model.mStart) {
