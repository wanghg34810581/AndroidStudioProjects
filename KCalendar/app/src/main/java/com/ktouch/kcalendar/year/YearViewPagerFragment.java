...
import com.ktouch.datetimepicker.date.SimpleMonthView;
...
public class YearViewPagerFragment extends Fragment implements CalendarController.EventHandler {
    ...
    private static final int EPOCH_TIME_YEAR_END = 2037; //wangqin fixed it for ending date to 2037 at PROD103829338
    ...
    /*TYRD:wb037 20150529 add for PROD103763270 begin*/
    private long mTimeMillis;
    /*TYRD:wb037 20150529 add for PROD103763270 end*/
    ...
    private void updateTitle(int year) {
        ...
        /*TYRD:wb037 20150529 modify for PROD103763270 begin*/
        //start.set(1, 1, year);
        start.set(mTimeMillis);
        start.set(start.monthDay, start.month, year);
        /*TYRD:wb037 20150529 modify for PROD103763270 end*/
    ...
    public static class YearViewPagerAdapter extends FragmentPagerAdapter {
        ...
        // returns the count of years from 1970 - 2037 (inclusive)
        @Override
        public int getCount() {
            return 68;  //wangqin fixed it for ending date to 2037 at PROD103829338 at PROD103829338
        }
    }
