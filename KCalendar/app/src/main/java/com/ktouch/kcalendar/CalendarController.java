...
public class CalendarController {
    ...
    public static final int MAX_CALENDAR_YEAR = 2037;//wangqin fixed it for ending date to 2037 at PROD103829338
    public static final int MIN_CALENDAR_WEEK = 0;
    public static final int MAX_CALENDAR_WEEK =3549; //3497; // weeks between 1/1/1970 and 1/1/2038 fixed by wangqin
    ...
    public interface EventType {
        ...
        // Agenda activity for 3 years
        final long LAUNCH_AGENDA_ACTIVITY = 1L << 12;

        final long VACATION_GO_TO = 1L << 13;
    }
    ...
    public void sendEvent(Object sender, long eventType, Time start, Time end, long eventId,
            int viewType) {
            Log.i("wanghg", "sendEvent 1  eventType = " + eventType);
    ...
    public void sendEvent(Object sender, long eventType, Time start, Time end, long eventId,
            ...
            Log.i("wanghg", "sendEvent 2  eventType = " + eventType);
    ...
    public void sendEvent(Object sender, long eventType, Time start, Time end, Time selected,
            ...
            Log.i("wanghg", "sendEvent 3  eventType = " + eventType);
        EventInfo info = new EventInfo();
        info.eventType = eventType;
    ...
    public void sendEvent(Object sender, final EventInfo event) {
        ...
        Log.i("wanghg", "sendEvent 4  eventType = " + event.eventType);
        ...
        if (DEBUG) Log.d(TAG,"mDetailViewType:"+mDetailViewType+" mViewType:"+mViewType);
        // Fix up view if not specified
        if (event.viewType == ViewType.DETAIL) {
            //yanghong add for PROD103564889 on Feb.4,2015
            if(mViewType == ViewType.MONTH){
                mDetailViewType = ViewType.DAY;
            }
            //yanghong add end
        ...
        if (!handled) {
            ...
            // Launch Agenda Activity
            if (event.eventType == EventType.LAUNCH_AGENDA_ACTIVITY) {
    ...
    private void launchAgendaActivity() {
        // TODO: 2016/4/26 0026 It will be written after AgendaActivity was created.
//        Intent intent = new Intent(Intent.ACTION_VIEW);
//        intent.setClass(mContext, CalendarSettingsActivity.class);
//        intent.setFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT | Intent.FLAG_ACTIVITY_SINGLE_TOP);
//        mContext.startActivity(intent);
...
//    }
    ...
    private String eventInfoToString(EventInfo eventInfo) {
        ...
        if ((eventInfo.eventType & EventType.GO_TO) != 0) {
            ...
            tmp = "Update title";
        } else if ((eventInfo.eventType & EventType.LAUNCH_AGENDA_ACTIVITY) != 0) {
            tmp = "Agenda Activity";
        }
        builder.append(tmp);
        builder.append(": id=");
