...
package com.ktouch.kcalendar.widget;
...
public class CalendarAppWidgetProvider extends AppWidgetProvider {
    ...
    static final String EXTRA_EVENT_IDS = "com.ktouch.kcalendar.EXTRA_EVENT_IDS";
    ...
    private void performUpdate(Context context,
        ...
        for (int appWidgetId : appWidgetIds) {
            ...
            launchCalendarIntent
                    .setData(Uri.parse("content://com.ktouch.kcalendar/time/" + millis));
    ...
    static Intent getLaunchFillInIntent(Context context, long id, long start, long end,
        ...
        String dataString = "content://com.ktouch.kcalendar/events";
        if (id != 0) {
            ...
            fillInIntent.setClass(context, EditEventActivity.class);
        } else {
