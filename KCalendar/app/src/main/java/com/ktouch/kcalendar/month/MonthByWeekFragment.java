...
public class MonthByWeekFragment extends SimpleDayPickerFragment implements
    ...
    public void doResumeUpdates() {
        ...
        //yanghong add for PROD103624718 on Mar.6,2015.
        //force to update: first force update the events when resume the screen
    ...
    protected void setMonthDisplayed(Time time, boolean updateHighlight) {
        ...
        if (!mIsMiniMonth) {
            ...
            //yanghong modify the selectedTime from time->mSelectedDay on Sep.26,2014
