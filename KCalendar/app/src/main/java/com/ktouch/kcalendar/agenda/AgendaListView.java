...
import com.ktouch.kcalendar.CalendarUtils.Triple;
import com.ktouch.kcalendar.Utils;
import com.ktouch.kcalendar.agenda.AgendaAdapter.ViewHolder;
import com.ktouch.kcalendar.agenda.AgendaWindowAdapter.DayAdapterInfo;
import com.ktouch.kcalendar.agenda.AgendaWindowAdapter.AgendaItem;
...
public class AgendaListView extends ListView implements OnItemClickListener {
    ...
    public static long mInstanceId;
    ...
    public static final int WINDOW_TYPE_WEEK = 0;
    public static final int WINDOW_TYPE_MONTH = 1;
    public static final int WINDOW_TYPE_YEAR = 2;
    public static final int WINDOW_TYPE_SEARCH = 3;
    ...
    public void goTo(Time time, long id, String searchQuery, boolean forced,
            ...
            Log.i("wanghg", "AgendaListView goTo");
        if (time == null) {
            time = mTime;
