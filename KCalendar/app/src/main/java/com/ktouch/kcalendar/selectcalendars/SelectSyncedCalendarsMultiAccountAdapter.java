...
package com.ktouch.kcalendar.selectcalendars;
...
//import com.ktouch.kcalendar.CalendarColorPickerDialog;
import com.ktouch.kcalendar.R;
import com.ktouch.kcalendar.Utils;
import com.ktouch.kcalendar.selectcalendars.CalendarColorCache.OnCalendarColorsLoadedListener;
...
*/
        //yanghong add for vertical-center begin
        TextView textView = (TextView)view.findViewById(R.id.account_type);
        if(accountLabel != null){
            String s = accountLabel.toString();
