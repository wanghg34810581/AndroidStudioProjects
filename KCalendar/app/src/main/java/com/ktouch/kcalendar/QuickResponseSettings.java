...
/*wangqin add for PROD103892437 OnPreferenceClickListener OnPreferenceClickListener begin*/
public class QuickResponseSettings extends PreferenceFragment implements OnPreferenceChangeListener,OnPreferenceClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (mResponses != null) {
            ...
            for (String response : mResponses) {
				...
				/*wangqin add for PROD103892437 begin*/
				et.setOnPreferenceClickListener(this);
				/*wangqin add for PROD103892437 end*/
                mEditTextPrefs[i++] = et;
                ps.addPreference(et);
            }
        } else {
  ...
  @Override
	public boolean onPreferenceClick(Preference preference) {
		if(preference instanceof EditTextPreference){
	        EditText mText = ((EditTextPreference)preference).getEditText();
