...
/*TYRD:wb037 20150520 add for PROD103762657 begin*/
import android.graphics.drawable.ColorDrawable;
/*TYRD:wb037 20150520 add for PROD103762657 end*/
...
public class QuickResponseActivity extends ListActivity implements OnItemClickListener {
    ...
    protected void onCreate(Bundle icicle) {
        ...
        /*TYRD:wb037 20150520 add for PROD103762657 begin*/
        getListView().setDivider(new ColorDrawable(getResources().getColor(R.color.create_event_divider_color)));
        getListView().setDividerHeight((int)getResources().getDimension(R.dimen.list_divider_height));
        /*TYRD:wb037 20150520 add for PROD103762657 end*/
        /*TYRD:wb037 20150520 modify for PROD103762657 begin*/
        //setListAdapter(new ArrayAdapter<String>(this, R.layout.quick_response_item, mResponses));
        setListAdapter(new ArrayAdapter<String>(this, R.layout.quick_response_item, android.R.id.text1,mResponses));
        /*TYRD:wb037 20150520 modify for PROD103762657 begin*/
    }
