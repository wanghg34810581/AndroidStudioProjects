    ...
    public static String getRepeatString(Context context, Resources r, EventRecurrence recurrence,
        ...
        switch (recurrence.freq) {
            case EventRecurrence.DAILY:
                //yanghong add on Oct.17,2014
                //donot know why the getQuantityString doesn't work
                String s;
                if(interval == 1){
                    s = r.getString(R.string.daily)+endString;
                }else{
                    s = r.getString(R.string.dailyrepeat, interval)+endString;
                }
                //return r.getQuantityString(R.plurals.daily, interval, interval) + endString;
                //android.util.Log.d("yanghong", "repeat:"+s);
                return s;
            case EventRecurrence.WEEKLY: {
                if (recurrence.repeatsOnEveryWeekDay()) {
                    ...
                    String s1;
                    if(interval == 1){
                        s1 = r.getString(R.string.weekly, string)+endString;
                    }else{
                        s1 = r.getString(R.string.weeklyrepeat,interval, string)+endString;
                    }
                    //android.util.Log.d("yanghong", "repeat:"+s1);
