...
public class WheelView extends View {
	...
	private void initResourcesIfNecessary() {
		if (itemsPaint == null) {
			...
			itemsPaint.setTextSize(sp2px(context, 15));
		}

		if (valuePaint == null) {
			valuePaint = new TextPaint(Paint.ANTI_ALIAS_FLAG | Paint.DITHER_FLAG);
			valuePaint.density = getResources().getDisplayMetrics().density;
			valuePaint.setTextSize(sp2px(context, 17));
		...
		if (labelPaint == null) {
			...
			labelPaint.setColor(context.getResources().getColor(R.color.primary_text_black_color));
			labelPaint.setTextSize(sp2px(context, 12));
		}
	...
	private int getMaxTextLength() {
		...
		if (adapterLength > 0 && adapterLength<=60) {
	...
	private void createLayouts(int widthItems, int widthLabel) {
		if (itemsLayout == null || itemsLayout.getWidth() > widthItems) {
			itemsLayout = new StaticLayout(buildText(isScrollingPerformed), itemsPaint, widthItems, Layout.Alignment.ALIGN_CENTER, 1,
		...
		if (!isScrollingPerformed && (valueLayout == null || valueLayout.getWidth() > widthItems)) {
			...
			valueLayout = new StaticLayout(text != null ? text : "", valuePaint, widthItems, Layout.Alignment.ALIGN_CENTER, 1,
					ADDITIONAL_ITEM_HEIGHT, false);
	...
	private void drawValue(Canvas canvas) {
		...
		valuePaint.setColor(context.getResources().getColor(R.color.primary_text_green_color));
	...
	private void drawItems(Canvas canvas) {
		...
		itemsPaint.setColor(context.getResources().getColor(R.color.primary_text_gray_color));
