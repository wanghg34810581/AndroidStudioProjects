 ...
 */
public final class SecApplication extends Application {
    public static final String TAG = "SecApplication";
...
//		});
        ...
        // TMSDK初始化
        mBresult   = TMSDKContext.init(this, SecSecureService.class,  new ITMSApplicaionConfig() {
...
//						ret.put(TMSDKContext.USE_IP_LIST, "false");
        ...
        Log.d(TAG, "TMSDK init spend =" + (end - start));
        Log.d(TAG, "init result = " + mBresult);
    }
}