...
public class NumberPicker extends LinearLayout {
    ...
    private final static String TAG = "flow-NumberPicker";
     ...
     */
    private final EditText mInputText, mInputSeleteText;
    ...
    public NumberPicker(Context context, AttributeSet attrs, int defStyle) {
        ...
        if(DEBUG) {
            Log.e(TAG, "R.styleable.NumberPicker=" + R.styleable.NumberPicker);
            Log.e(TAG, "attributesArray=" + attributesArray);
            Log.e(TAG, "attrs=" + attrs);
            Log.e(TAG, "defStyle=" + defStyle);
            Log.e(TAG, "context=" + context);
        }
        final int layoutResId = attributesArray.getResourceId(
                R.styleable.NumberPicker_internalLayout, DEFAULT_LAYOUT_RESOURCE_ID);
        if(DEBUG) {
            Log.e(TAG, "layoutResId=" + layoutResId);
            Log.e(TAG, "R.styleable.NumberPicker_internalLayout=" + R.styleable.NumberPicker_internalLayout);
        }
        ...
        if(DEBUG) {
            Log.e(TAG, "defSelectionDividerHeight=" + defSelectionDividerHeight);
        }
        mSelectionDividerHeight = attributesArray.getDimensionPixelSize(
                R.styleable.NumberPicker_selectionDividerHeight, defSelectionDividerHeight);
        if(DEBUG) {
            Log.e(TAG, "mSelectionDividerHeight=" + mSelectionDividerHeight);
        }
        ...
        if(DEBUG) {
            Log.e(TAG, "22 mComputeMaxWidth=" + mComputeMaxWidth);
        }
        ...
        mInputSeleteText = (EditText) findViewById(R.id.np__numberpicker_selete);
        mInputText.setFocusable(false);
        //mInputSeleteText.setFocusable(false);
        //mInputText.setTextSize(30);
...
//        });
        ...
        //zouchl add
        mMaxHeight = dip2px(context, 16)*10 + sp2px(context, 19) + sp2px(context, 17) * 4;
        //zouchl add end
        if(DEBUG) {
            Log.e(TAG, "22 mMaxHeight=" + mMaxHeight);
        }
        ...
        int color = (int) mInputText.getCurrentTextColor();
        if(DEBUG) {
            Log.e(TAG, "mTextSize=" + mTextSize + ",color=" + color);
        }
...
//        int color = colors.getColorForState(ENABLED_STATE_SET, Color.WHITE);
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        if(DEBUG) {
            Log.e(TAG, "22 msrdWdth=" + msrdWdth);
            Log.e(TAG, "22 msrdHght=" + msrdHght);
        }
        // Input text centered horizontally.
        final int inptTxtMsrdWdth = mInputText.getMeasuredWidth();
        final int inptTxtMsrdHght = mInputText.getMeasuredHeight();
        if(DEBUG) {
            Log.e(TAG, "22 inptTxtMsrdWdth=" + inptTxtMsrdWdth);
            Log.e(TAG, "22 inptTxtMsrdHght=" + inptTxtMsrdHght);
        }
        ...
        if(DEBUG) {
            Log.e(TAG, "22 inptTxtLeft=" + inptTxtLeft);
            Log.e(TAG, "22 inptTxtTop=" + inptTxtTop);
            Log.e(TAG, "22 inptTxtRight=" + inptTxtRight);
            Log.e(TAG, "22 inptTxtBottom=" + inptTxtBottom);
        }
        ...
        if (changed) {
            ...
            if(DEBUG) {
                Log.e(TAG, "22 mSelectionDividersDistance=" + mSelectionDividersDistance);
                Log.e(TAG, "22 mTopSelectionDividerTop=" + mTopSelectionDividerTop);
            }
...
//            mInputText.setVisibility(View.INVISIBLE);
    ...
    private boolean updateInputTextView() {
        ...
        if(DEBUG) {
            Log.e(TAG, "updateInputTextView text=" + text + ",mDisplayedValues=" + mDisplayedValues);
            Log.e(TAG, "updateInputTextView TextUtils.isEmpty(text)=" + TextUtils.isEmpty(text)
                    + ",mInputText.getText().toString())=" + mInputText.getText().toString());
            Log.e(TAG, "text.equals(mInputText.getText().toString()=" + text.equals(mInputText.getText().toString()));
        ...
        if (!TextUtils.isEmpty(text) && !text.equals(mInputText.getText().toString())) {
           ...
           // }
//zouchl
            //mInputText.setTextColor(getResources().getColor(R.color.red));
            //mInputText.setTextSize(25);

            //mInputSeleteText.setFocusable(false);

            //mInputSeleteText.setRawInputType(InputType.TYPE_CLASS_NUMBER);
            //mInputSeleteText.setImeOptions(EditorInfo.IME_ACTION_DONE);

            int size = (int) mInputSeleteText.getTextSize();
            int color = (int) mInputSeleteText.getCurrentTextColor();
            if(DEBUG) {
                Log.e(TAG, "size=" + size + ",color=" + color + ",sp=" + px2sp(getContext(), size));
            }

            mInputText.setTextColor(color);

            mInputText.setTextSize(px2sp(getContext(), size));
            if(DEBUG) {
                Log.e(TAG, "updateInputTextView setTextSize=" + sp2px(getContext(), 19));
            }
            return true;
        }
