...
import com.realfame.fileexplorer.R;
...
public class FTPServerService extends Service implements Runnable {
    ...
    private void setupNotification() {
		...
		notificationIntent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK|Intent.FLAG_ACTIVITY_CLEAR_TOP);//TYRD:weina 20150902 add for PROD104005402
