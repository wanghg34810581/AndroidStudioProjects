...
public class FavoriteList implements FavoriteDatabaseListener {
    ...
    public FavoriteList(Context context, ListView list, FavoriteDatabaseListener listener,
        ...
        mFavoriteDatabase = new FavoriteDatabaseHelper(context);
        mFavoriteDatabase.setOnFavoriteDatabaseListener(listener);
    ...
    public void initList() {
        ...
        if (c != null)
            c.close();
        /*TYRD: weina 20150826 deleted begin*/
        ...
        /*TYRD: weina 20150826 deleted end*/
        update();
    }
