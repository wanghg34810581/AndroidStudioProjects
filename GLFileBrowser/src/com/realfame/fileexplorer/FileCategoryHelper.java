...
import com.realfame.fileexplorer.MediaFile.MediaFileType;
...
public class FileCategoryHelper {
    ...
    static {
       ...
       // categoryNames.put(FileCategory.Theme, R.string.category_theme);//TYRD: weina 20150818 deleted for PROD103986761
        categoryNames.put(FileCategory.Doc, R.string.category_document);
       // categoryNames.put(FileCategory.Zip, R.string.category_zip);//TYRD: weina 20150818 deleted for PROD103986761
    ...
    };//TYRD: weina 20150818 deleted  FileCategory.Theme,AND FileCategory.Zip, for PROD103986761
    ...
    private String buildSortOrder(SortMethod sort) {
        ...
        switch (sort) {
            ...
            case date:
                ...
                break;
            case type:
				/*TYRD: weina 20151019 modity for Prod104072680 begin*/
                //sortOrder = FileColumns.MIME_TYPE + " asc, " + FileColumns.TITLE + " asc";
                sortOrder = FileColumns.MIME_TYPE + " asc ";
                /*TYRD: weina 20151019 modity for Prod104072680 end*/
                break;
        }
        return sortOrder;
    }
