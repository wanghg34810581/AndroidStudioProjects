...
public class FileIconLoader implements Callback {
     ...
     */
    private final  ConcurrentHashMap<String, ImageHolder> mImageCache = new ConcurrentHashMap<String, ImageHolder>();
	...
	public void setOnIconLoadFinishListener(IconLoadFinishListener l){
        iconLoadListener = l;
	}
	...
	/*TYRD:weina 20150902 add for PROD104004711 BEGIN*/
	public void removeCachedIcon(String path){
        mImageCache.remove(path);
	}
	/*TYRD:weina 20150902 add for PROD104004711 END*/
    ...
    private class LoaderThread extends HandlerThread implements Callback {
        ...
        private static final int MICRO_KIND = 1;//=3;TYRD: weina 20150624 modify 

        private Bitmap getImageThumbnail(long id) {
             Bitmap bitmap = Images.Thumbnails.getThumbnail(mContext.getContentResolver(), id, MICRO_KIND, null);
